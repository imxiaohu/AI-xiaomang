...
| **配置项** | **说明** |
| --- | --- |
| 调用地址 | 华北2（北京）地域：wss://dashscope.aliyuncs.com/api-ws/v1/realtime 新加坡地域：wss://{WorkspaceId}.ap-southeast-1.maas.aliyuncs.com/api-ws/v1/realtime，其中WorkspaceId需替换为真实的业务空间 ID。 |
...
-   **选择交互模式**
    ...
    # 指定地域，设为cn表示华北2（北京）地域，设为intl表示新加坡地域
    region = 'cn'
